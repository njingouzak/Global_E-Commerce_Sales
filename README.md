...
The dataset used in this project has been downloaded from `Kaggle` platform (https://www.kaggle.com/datasets/muhammadaammartufail/global-e-commerce-sales-and-customer-data/data). It contains 2000 transactions and 15 features:
